...
ApplicationWindow {
                    ...
                    ColumnLayout {
                        ...
                        Button {
                            ...
                            onClicked: {
                                ...
                                var newId = 0;
                                if (dbManager && userEmail) {
                                    var result = dbManager.addNote(userEmail, newNote);
                    ...
                    ColumnLayout {
                        ...
                        TextArea {
                            ...
                            background: Rectangle {
                                ...
                                border.width: 1;
                                border.color: Material.color(Material.Grey, Material.Shade300);
                                implicitHeight: detailContentArea.contentHeight + 20
                            }
                        }
                    }
                }
    ...
    Component {
        ...
        Page {
            ...
            function loadNotes() {
                if (dbManager && userEmail) {
                    var notes = dbManager.getNotesForUser(userEmail);
                    notesModel.clear();
            ...
            Drawer {
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        Image {
                            id: avatar
                            source: "qrc:/images/1.jpg" // Замініть на свій шлях
                            anchors.fill: parent
                    ...
                    Button {
                        ...
                        onClicked: {
                            drawer.close();
                            notesModel.clear(); // Очищення нотаток при виході
                        ...
                        TextField {
                            ...
                            ToolButton {
                                ...
                                contentItem: CheckBox {
                                    ...
                                    checked: false
                                    indicator: Label {
                                        // ВИПРАВЛЕНО: Використовуємо parent.checked
                                        text: parent.checked ? "🔓" : "🔒"
                                        font.pixelSize: 18
                                        anchors.centerIn: parent
                                    }
